...
class CollectionUpdate(Notification):
...
class NotifyUnsubscribed(Notification):
...
JSONRPCMessage: TypeAlias = CollectionUpdate | NotifyUnsubscribed | Response
